...
const S: Record<string, React.CSSProperties> = {
  ...
  headerTitle: { color: C.text, fontWeight: 600, fontSize: 13 },
  headerSub: { color: C.accent, fontSize: 12 },
  tabs: {
    display: 'flex',
    marginLeft: 12,
  ...
  version: { marginRight: 'auto', fontSize: 11, color: C.faint, fontVariantNumeric: 'tabular-nums' },
  footer: {
    display: 'flex',
    alignItems: 'center',
    gap: 8,
  ...
  sectionTitle: { fontSize: 12, fontWeight: 600, color: C.accent, marginBottom: 4 },
  sectionNote: { fontSize: 11, color: C.faint, lineHeight: 1.6, marginBottom: 8, maxWidth: '78ch' },
  rowWrap: {
    display: 'grid',
