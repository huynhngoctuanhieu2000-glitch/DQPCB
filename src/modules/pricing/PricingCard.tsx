...
const S: Record<string, React.CSSProperties> = {
  ...
  stencilHead: { display: 'flex', justifyContent: 'space-between', fontSize: 11, color: C.muted, marginBottom: 4 },
  stencilFor: { color: C.faint },
  stencilMain: { fontSize: 13, fontWeight: 600, color: C.text },
  stencilNote: { fontSize: 11, color: C.muted, marginTop: 2 },
  panelToggle: {
    display: 'flex',
    alignItems: 'center',
    gap: 8,
  ...
  panelHint: { marginLeft: 'auto', fontSize: 11, color: C.accent, fontWeight: 600 },
  ...
  qtyResult: { minWidth: 60, textAlign: 'right', fontSize: 14, fontWeight: 700, color: C.text, padding: '4px 8px' },
  panelSize: { fontSize: 11, color: C.muted, textAlign: 'right', paddingTop: 2 },
  specHead: {
    width: '100%',
    display: 'flex',
    alignItems: 'baseline',
  ...
  specHeadArrow: { fontSize: 11, color: C.faint },
  specHeadLabel: { fontSize: 12, color: C.muted },
  specHeadValue: { fontSize: 12, color: C.text, fontWeight: 600, flex: 1, minWidth: 0 },
  specRow: { padding: '6px 0', display: 'flex', flexDirection: 'column', gap: 6 },
  specLabel: { fontSize: 11, color: C.muted, textTransform: 'uppercase', letterSpacing: 0.4 },
  ...
  infoLabel: { color: C.muted, fontSize: 11, flexShrink: 0 },
  infoValue: {
    marginLeft: 'auto',
    display: 'flex',
  ...
  title: { color: C.text, fontWeight: 600, fontSize: 12 },
  ...
  pathToggle: { display: 'flex', gap: 2, padding: 2, borderRadius: 999, backgroundColor: C.panelAlt, border: '1px solid #2c313c' },
  pathBtn: {
    fontSize: 11,
    fontWeight: 600,
    minHeight: 24,
  ...
  badgeFormula: { backgroundColor: '#3b2c09', color: C.warnText, border: '1px solid #57410d' },
  gear: {
    marginLeft: 'auto',
    width: 28,
    height: 28,
  ...
  label: { color: C.muted, fontSize: 11, flex: 1, whiteSpace: 'nowrap' },
  ...
  unit: { color: C.faint, fontSize: 10 },
  originLine: {
    display: 'flex',
    alignItems: 'center',
    gap: 6,
  ...
  offTitle: { color: C.warnText, fontSize: 11, fontWeight: 600, marginBottom: 2 },
  ...
  priceMainOff: { color: C.muted, fontWeight: 600 },
  ...
  priceSub: { color: C.muted, fontSize: 11, marginTop: 2, display: 'flex', gap: 6 },
  modeTag: { color: C.faint, fontSize: 10 },
  breakdown: { width: '100%', borderCollapse: 'collapse', marginBottom: 8 },
  breakLabel: { color: C.faint, fontSize: 10, padding: '2px 0' },
  ...
  segBtnOn: { backgroundColor: C.border, color: C.text },
  check: {
    display: 'flex',
    alignItems: 'center',
    gap: 5,
